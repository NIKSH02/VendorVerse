      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-2xl font-bold text-orange-500">Raw</h3>
            <p className="text-gray-400 max-w-xs">
              Connecting local vendors with customers, providing fresh and quality products at your doorstep.
            </p>
          ...
          >
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>123 Market St., Suite 456, San Francisco, CA 94105</span>
              </li>
            </ul>
          </motion.div>
        ...
        >
          <p>© 2025 Raw. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
