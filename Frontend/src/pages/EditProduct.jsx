    ...
    try {
      ...
      Object.keys(formData).forEach((key) => {
        if (key === "image" && !formData[key]) {
          // Skip image if no new image is selected
          return;
        }

        if (key === "location") {
          // Skip location - we don't want to include it in edit
          return;
        }
      ...
      const response = await productsAPI.updateProduct(productId, submitData);
